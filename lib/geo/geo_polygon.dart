...
class GeoPolygon {
  ...
  List<GeoCoordinate2D> getCoordinates({required GeoAngle startAngle, bool clockwise = false, required Size size, BoxFit boxFit = BoxFit.none}) {
  ...
  Path getPath({required GeoAngle startAngle, bool clockwise = false, required Size size, BoxFit boxFit = BoxFit.none, double cornerRadius = 0}) {
    List<GeoCoordinate2D> coords = getCoordinates(startAngle: startAngle, clockwise: clockwise, size: size, boxFit: boxFit);
