...
class GuiShapeStar implements IGuiShape {
  ...
  GuiShapeStar({required this.sides, required this.startAngle, this.indentSideFactor = 0.5, this.clockwise = false, this.boxFit = BoxFit.none, this.cornerRadius = 0}) {
  ...
  Path getPath({required Size size}) {
    return _shape.getPath(startAngle: startAngle, clockwise: clockwise, indentSideFactor: indentSideFactor, size: size, boxFit: boxFit, cornerRadius: cornerRadius);
  }
  ...
  IGuiShape lerpFrom(IGuiShape shape, double t) {
    if (shape is GuiShapeStar) {
      return GuiShapeStar(
          ...
          startAngle: GeoAngle(radian: lerpDouble(shape.startAngle.radian, startAngle.radian, t)),
          indentSideFactor: lerpDouble(shape.indentSideFactor, indentSideFactor, t)!,
          clockwise: clockwise,
          boxFit: boxFit,
  ...
  IGuiShape lerpTo(IGuiShape shape, double t) {
    if (shape is GuiShapeStar) {
      return GuiShapeStar(
          ...
          startAngle: GeoAngle(radian: lerpDouble(startAngle.radian, shape.startAngle.radian, t)),
          indentSideFactor: lerpDouble(indentSideFactor, shape.indentSideFactor, t)!,
          clockwise: clockwise,
          boxFit: boxFit,
