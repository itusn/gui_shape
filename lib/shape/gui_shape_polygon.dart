...
class GuiShapePolygon implements IGuiShape {
  ...
  GuiShapePolygon({required this.sides, required this.startAngle, this.clockwise = false, this.boxFit = BoxFit.none, this.cornerRadius = 0}) {
  ...
  Path getPath({required Size size}) {
    return _polygon.getPath(startAngle: startAngle, clockwise: clockwise, size: size, boxFit: boxFit, cornerRadius: cornerRadius);
  }
